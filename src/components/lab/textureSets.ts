...
export const TEXTURE_SETS: Record<Exclude<TextureSetKey, 'none'>, TextureSet> = {
  red_brick_03: {
    ...
    category: 'wall',
    diff: `${base('red_brick_03')}_diff_2k.jpg`,
  ...
  castle_brick_07: {
    ...
    category: 'wall',
    diff: `${base('castle_brick_07')}_diff_2k.jpg`,
  ...
  concrete_wall_004: {
    label: '콘크리트 (거친)',
    category: 'wall',
    diff: `${base('concrete_wall_004')}_diff_2k.jpg`,
  ...
  wood_planks: {
    label: '나무 마루',
    category: 'floor',
    diff: `${base('wood_planks')}_diff_2k.jpg`,
  ...
  marble_01: {
    label: '대리석',
    category: 'any',
    diff: `${base('marble_01')}_diff_2k.jpg`,
